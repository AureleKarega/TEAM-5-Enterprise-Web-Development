...
-- MoMo SMS Project schema (MySQL 8+)
-- Run: mysql -u <user> -p < database_setup.sql
...
-- Transaction tags (many-to-many example)
...
-- TAG LINKS (join transactions to tags)
